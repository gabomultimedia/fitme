...
export const EQUIPMENT_CATALOG: EquipmentOption[] = [
  ...
  { id: "cable", label: "Cable / Poleas", shortLabel: "Cable", icon: Cable, category: "machines" },
  ...
  { id: "exercise_ball", label: "Pelota", shortLabel: "Pelot", icon: CircleDot, category: "accessories" },
